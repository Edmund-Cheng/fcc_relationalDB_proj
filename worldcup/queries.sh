...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams AS t LEFT JOIN games AS a ON a.winner_id = t.team_id LEFT JOIN games AS b ON b.opponent_id = t.team_id WHERE (a.year=2014 AND a.round='Eighth-Final') OR (b.year=2014 AND b.round='Eighth-Final')")"
